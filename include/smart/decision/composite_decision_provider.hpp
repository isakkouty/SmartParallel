...
class CompositeDecisionProvider
{
  public:
                                         ...
                                         const ExecutionHints& hints) const
    {
        ...
        DecisionRecommendation historical_recommendation = historical.recommend(context, hints);

        DecisionRecommendation analytical_recommendation = analytical.recommend(context, hints);

        if (historical_recommendation.available && analytical_recommendation.available)
        {
