...
set "BUILD_DIR=%REPO_ROOT%\build\execution_lineage_runtime_inheritance"

echo(
echo ==== [1/3] Configure execution lineage example ====
...
echo(
echo ==== [2/3] Build execution lineage example ====
cmake --build "%BUILD_DIR%" --target smartparallel_execution_lineage_runtime_inheritance
if errorlevel 1 goto :fail

echo(
echo ==== [3/3] Run execution lineage and runtime inheritance ====
"%BUILD_DIR%\examples\smartparallel_execution_lineage_runtime_inheritance.exe"
if errorlevel 1 goto :fail

echo(
echo ============================================================
echo Execution lineage and runtime inheritance completed successfully.
echo ============================================================
exit /b 0
...
:fail
echo(
echo Execution lineage and runtime inheritance failed. Review the first error above.
exit /b 1
