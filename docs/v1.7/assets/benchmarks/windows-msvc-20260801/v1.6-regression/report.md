...
- Fast-mode paired ratio: **0.9766x** (90% robust interval 0.9096–1.0486x; PASS)
...
|---|---:|
| Direct sequential reference | 0.8683 |
| Retained legacy Fast overload | 0.2358 |
| Policy-aware Fast | 0.2753 |
| Reproducible | 0.2947 |
| Accurate | 1.6638 |
...
|---|---:|---:|---:|
| axpy | 1.1953 | 1.8951 | 1.585x |
| dot | 0.817 | 0.977 | 1.196x |
| norm | 0.3485 | 0.8962 | 2.572x |
| stencil_2d | 1.3866 | 1.9908 | 1.436x |
| heat_diffusion_20 | 4.3074 | 8.3712 | 1.943x |

## Heat diffusion — 20 iterations

| Policy | Median stable time (ms) | Scheduler evidence | Speed vs direct sequential |
|---|---:|---|---:|
| Fast | 4.3074 | ThreadPool | 1.943x |
| Reproducible | 4.3186 | ThreadPool | 1.938x |
| Accurate | 4.527 | ThreadPool | 1.849x |
| Direct sequential | 8.3712 | DirectSequential | 1.000x |
