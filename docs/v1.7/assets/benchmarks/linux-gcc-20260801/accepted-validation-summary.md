...
- v1.7 paired benchmark analysis found no statistically credible objective failure at 31 repetitions. Warm-start, Deterministic latency, and profile-scale gates passed; the two sub-millisecond API-overhead intervals were `NOT-ESTABLISHED`.
