...
Result run_case(std::size_t count)
{
    ...
    for (int run = 0; run < runs; ++run)
    {
        ...
        smart::for_each(values, irregular_work);
...
int main()
{
    ...
    std::ofstream csv(
        "benchmarks\\irregular_workload\\output\\beta_1_0\\results.csv"
    );
